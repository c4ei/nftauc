    ...
    return(
        ...
        <VStack w={{lg:'50%', md: '50%', sm: '80%', base: '80%'}} h='70px'>
            <HStack w='full' h='50px' borderRadius={6} border='1px solid #A0AEC0'>
                ...
                placeholder={network.id == 21004 ? "Amount of C4EI to Offer" : network.id == 8217 ? "Amount of KLAY to Offer" : network.id == 4 ? "Amount of ETH to Offer" : "Amount of BNB to Offer"}
                border='none'
                />
